...
#[derive(Debug, CandidType, Deserialize)]
pub struct VetkdDeriveKeyArgsKeyId {
    pub name: String,
...
pub struct VetkdDeriveKeyArgs {
    ...
    pub key_id: VetkdDeriveKeyArgsKeyId,
    pub input: serde_bytes::ByteBuf,
    pub transport_public_key: serde_bytes::ByteBuf,
}
...
impl ChainkeyTestingCanister {
    ...
    pub async fn vetkd_derive_key(
        &self,
        arg0: VetkdDeriveKeyArgs,
    ) -> Result<(VetkdDeriveKeyResult,)> {
        ic_cdk::call(self.0, "vetkd_derive_key", (arg0,)).await
    }
