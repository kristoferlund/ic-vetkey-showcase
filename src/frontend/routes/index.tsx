...
function Index() {
  return (
    <div className="text-lg flex flex-col gap-5">
      ...
      <Link to="/timelock" className="underline">
        <div className="flex items-center gap-2 border p-5 rounded-md bg-white/10 hover:bg-white/20">
          <Timer className="w-10 h-10" />
          <h2>Timelock</h2>
        </div>
      </Link>
      <div>(more examples coming)</div>
      <div className="flex flex-col gap-2">
        ...
        <div>
          ...
          – This page contains a high-level view and description of vetKD and
          its building blocks.
        </div>
      </div>
    </div>
